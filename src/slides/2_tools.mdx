...
- Analysis and Tools are on either side of the data, input and output
...
Notes: Comparison with existing ideas like

- Individual analysis libraries
- Custom lab code
- Fancy purpose-built dashboards

---

# Experimental Framework

<Box width={9/10} marginLeft={"auto"} marginRight={"auto"}>
  <Text>How can you possibly build tools for an infinite variety of preps and hardware?</Text>
</Box>
...
<SvgAnimator
  ...
  style={{top:"100px", transform:"scale(0.8)", transformOrigin:'center'}}
/>
